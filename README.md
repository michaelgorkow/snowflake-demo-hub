...
GRANT ROLE SNOWFLAKE_DEMO_HUB_ROLE TO USER ADMIN;
...
FROM '@SNOWFLAKE_DEMO_HUB.PUBLIC.GITHUB_REPO_SNOWFLAKE_DEMO_HUB/branches/main/app/'
QUERY_WAREHOUSE = 'WH_XSMALL'
TITLE = 'SNOWFLAKE_DEMO_HUB'
MAIN_FILE = 'main.py';
```